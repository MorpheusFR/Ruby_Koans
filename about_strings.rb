...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # ANSWER:
    # Because the method (<<) adds an element to the end of the array, the
    # string can be represented as an array of characters, (+ =) - with a
    # different data type, can add elements, in which case we can get an
    # unexpected result.
  end
